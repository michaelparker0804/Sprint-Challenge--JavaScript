...
for (let i = 0; i<graduates.length; i++) {
  let obj = {};
  obj.contact = graduates[i].first_name + " " + graduates[i].email;
...
for (let i = 0; i<graduates.length; i++) {
  ...
  if (graduates[i].university.includes('Uni')) {
    obj.university = graduates[i].university;
    uni.push(obj);
  }
  obj = {};   
}
...
*/
const populationTotal = zooAnimals.reduce((sum, animals) => {
  return sum += animals.population;
}, 0);
